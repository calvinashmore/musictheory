...
public class Keyboard extends JPanel {
  ...
  private ImmutableList<Integer> highlightNotes = ImmutableList.of();
  private ImmutableList<Integer> pressNotes = ImmutableList.of();
  ...
  public void setHighlightNotes(ImmutableList<Integer> highlightNotes) {
  ...
  public void paint(Graphics g) {
    ...
    for (int octave = startingOctave; octave < totalOctaves + startingOctave; octave++) {
      ...
      for (int i = 0; i < 7; i++) {
        ...
        int x = (octave - startingOctave) * octaveWidth + i * noteWidth;
      ...
      for (int i = 0; i < 7; i++) {
        ...
        int x = (octave - startingOctave) * octaveWidth + i * noteWidth - noteWidth / 3;
